...
-- --------------------------------------------------------
-- 9. ROW LEVEL SECURITY (wyłączone dla MVP, włącz produkcyjnie)
-- --------------------------------------------------------
...
-- Tymczasowe policies (wszystko dla service_role, anon read dla MVP)
...
SELECT
    ...
    -- Pierwszy załadunek (dla widoku tabeli)
